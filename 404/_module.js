...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('avynh' in $$props) $$invalidate(10, avynh = $$props.avynh);
		if ('cxdwd' in $$props) $$invalidate(11, cxdwd = $$props.cxdwd);
		...
		if ('cuhkg' in $$props) $$invalidate(14, cuhkg = $$props.cuhkg);
	};
...
function create_else_block$2(ctx) {
	...
	return {
		...
		l(nodes) {
			a_1 = claim_element(nodes, "A", { class: true, href: true });
			var a_1_nodes = children(a_1);
			t = claim_text(a_1_nodes, "Go Home");
			a_1_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(a_1, "class", "button");
			attr(a_1, "href", "/");
		},
		m(target, anchor) {
			insert_hydration(target, a_1, anchor);
...
function create_if_block$2(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var button_nodes = children(button);
			t = claim_text(button_nodes, "Go Back");
			button_nodes.forEach(detach);
			this.h();
		},
		h() {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", history.back());
				mounted = true;
			}
		},
		p: noop,
...
function create_fragment$3(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*from_internal*/ ctx[2]) return create_if_block$2;
	...
	return {
		...
		h() {
			attr(h1, "class", "svelte-1o2eoeh");
			attr(h3, "class", "svelte-1o2eoeh");
			attr(article, "class", "svelte-1o2eoeh");
			attr(div0, "class", "section-container");
			attr(main, "class", "svelte-1o2eoeh");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let { title } = $$props;
	let { subtitle } = $$props;
	let from_internal = false;

	onMount(async () => {
		$$invalidate(2, from_internal = document.referrer.split('/')[2] === 'www.chalkia.com');
	});
	...
	$$self.$$set = $$props => {
		...
		if ('avynh' in $$props) $$invalidate(12, avynh = $$props.avynh);
		if ('cxdwd' in $$props) $$invalidate(13, cxdwd = $$props.cxdwd);
		...
		if ('cuhkg' in $$props) $$invalidate(16, cuhkg = $$props.cuhkg);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('email' in $$props) $$invalidate(10, email = $$props.email);
		if ('avynh' in $$props) $$invalidate(11, avynh = $$props.avynh);
		if ('cxdwd' in $$props) $$invalidate(12, cxdwd = $$props.cxdwd);
		...
		if ('cuhkg' in $$props) $$invalidate(15, cuhkg = $$props.cuhkg);
