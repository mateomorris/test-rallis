...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('xlfzh' in $$props) $$invalidate(10, xlfzh = $$props.xlfzh);
		if ('zgjmt' in $$props) $$invalidate(11, zgjmt = $$props.zgjmt);
		if ('yylsz' in $$props) $$invalidate(12, yylsz = $$props.yylsz);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t4 = claim_text(h3_nodes, /*subtitle*/ ctx[4]);
			h3_nodes.forEach(detach);
		...
		h() {
			...
			attr(img, "class", "svelte-mffdgr");
			attr(h1, "class", "svelte-mffdgr");
			attr(h3, "class", "svelte-mffdgr");
			html_tag.a = t6;
			attr(h4, "class", "svelte-mffdgr");
			attr(a0, "href", a0_href_value = "https://pinterest.com/pin/create/button/?url=" + /*url*/ ctx[6] + "&media=" + encodeURI(/*image*/ ctx[2].src) + "&description=" + encodeURI(/*seo_description*/ ctx[1]));
			attr(a0, "target", "_social");
			attr(a0, "title", "Pin");
			attr(a0, "class", "svelte-mffdgr");
			...
			attr(a4, "class", "svelte-mffdgr");
			attr(div0, "class", "share");
			attr(div1, "class", "section-container svelte-mffdgr");
			attr(main, "class", "svelte-mffdgr");
		...
		p(ctx, [dirty]) {
			if (!current || dirty & /*image*/ 4 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[2].src)) {
			...
			if (!current || dirty & /*subtitle*/ 16) set_data(t4, /*subtitle*/ ctx[4]);
			if (!current || dirty & /*text*/ 32) html_tag.p(/*text*/ ctx[5]);

			if (!current || dirty & /*url, image, seo_description*/ 70 && a0_href_value !== (a0_href_value = "https://pinterest.com/pin/create/button/?url=" + /*url*/ ctx[6] + "&media=" + encodeURI(/*image*/ ctx[2].src) + "&description=" + encodeURI(/*seo_description*/ ctx[1]))) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('xlfzh' in $$props) $$invalidate(16, xlfzh = $$props.xlfzh);
		if ('zgjmt' in $$props) $$invalidate(17, zgjmt = $$props.zgjmt);
		if ('yylsz' in $$props) $$invalidate(18, yylsz = $$props.yylsz);
		if ('seo_title' in $$props) $$invalidate(0, seo_title = $$props.seo_title);
		if ('seo_description' in $$props) $$invalidate(1, seo_description = $$props.seo_description);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('email' in $$props) $$invalidate(10, email = $$props.email);
		if ('xlfzh' in $$props) $$invalidate(11, xlfzh = $$props.xlfzh);
		if ('zgjmt' in $$props) $$invalidate(12, zgjmt = $$props.zgjmt);
		if ('yylsz' in $$props) $$invalidate(13, yylsz = $$props.yylsz);
...
function create_fragment$5(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				seo_title: "Press: Jägermeister Contest | Foteini Chalkia",
				seo_description: "Theme of the competition was to create an outfit based on the philosophy, culture, and quality of Jägermeister."
			}
		});
	...
	component_1 = new Component$2({
			props: {
				...
				zgjmt: {
					"image": {
						"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/alice-jageland.jpg",
						"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/alice-jageland.jpg",
						"alt": "Jägermeister Contest",
						"size": null
					},
					"title": "Jägermeister Contest",
					"subtitle": "Next round is on the house",
					"text": "<p>Theme of the competition was to create an outfit based on the philosophy, culture, and quality of Jägermeister. An outfit characterised by the words: fierce, independent, strong, unpredictable.</p>\n<p>The outfit created got inspired by \"Alice in the Wonderland\" and the pumpkins of the fairytales. It was based on the colour palette of Jägermeister (green, orange, black) and expressed the independent and confident woman, ready to have a Jäge shot that would transform her to a \"Master Hunter\" (the meaning of Jägermeister).</p>\n<p><strong>Credits</strong></p>\n<p>Styling &amp; Clothes: <em>Foteini Chalkia</em></p>\n<p>Photography: <em>Stefanos Samios</em></p>\n<p>Make up &amp; hair: <em>Evi Karali</em></p>\n<p>Model: <em>Zoe Gianna</em></p>"
				},
				yylsz: {
					"badges": {
