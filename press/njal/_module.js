...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('etxha' in $$props) $$invalidate(10, etxha = $$props.etxha);
		if ('tmaus' in $$props) $$invalidate(11, tmaus = $$props.tmaus);
		if ('intsw' in $$props) $$invalidate(12, intsw = $$props.intsw);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('etxha' in $$props) $$invalidate(16, etxha = $$props.etxha);
		if ('tmaus' in $$props) $$invalidate(17, tmaus = $$props.tmaus);
		if ('intsw' in $$props) $$invalidate(18, intsw = $$props.intsw);
		if ('seo_title' in $$props) $$invalidate(0, seo_title = $$props.seo_title);
		if ('seo_description' in $$props) $$invalidate(1, seo_description = $$props.seo_description);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('email' in $$props) $$invalidate(10, email = $$props.email);
		if ('etxha' in $$props) $$invalidate(11, etxha = $$props.etxha);
		if ('tmaus' in $$props) $$invalidate(12, tmaus = $$props.tmaus);
		if ('intsw' in $$props) $$invalidate(13, intsw = $$props.intsw);
...
function create_fragment$5(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				seo_title: "Press: NJAL | Foteini Chalkia",
				seo_description: "NJAL, a world leading platform for showcasing pioneer designers in contemporary fashion, has featured our brand CHALKIA at its homepage."
			}
		});
	...
	component_1 = new Component$2({
			props: {
				...
				tmaus: {
					"image": {
						"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/njal.jpg",
						"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/njal.jpg",
						"alt": "Jägermeister Contest",
						"size": null
					},
					"title": "NJAL",
					"subtitle": "Not Just A Label",
					"text": "<p>NOT JUST A LABEL (NJAL), a world leading platform for showcasing pioneer designers in contemporary fashion, has featured our brand CHALKIA at its homepage, as one of the designers that represent their platform best.</p>"
				},
				intsw: {
					"badges": {
