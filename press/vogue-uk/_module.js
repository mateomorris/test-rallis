...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('gunxm' in $$props) $$invalidate(10, gunxm = $$props.gunxm);
		if ('acwrb' in $$props) $$invalidate(11, acwrb = $$props.acwrb);
		if ('meeuq' in $$props) $$invalidate(12, meeuq = $$props.meeuq);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('gunxm' in $$props) $$invalidate(16, gunxm = $$props.gunxm);
		if ('acwrb' in $$props) $$invalidate(17, acwrb = $$props.acwrb);
		if ('meeuq' in $$props) $$invalidate(18, meeuq = $$props.meeuq);
		if ('seo_title' in $$props) $$invalidate(0, seo_title = $$props.seo_title);
		if ('seo_description' in $$props) $$invalidate(1, seo_description = $$props.seo_description);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('email' in $$props) $$invalidate(10, email = $$props.email);
		if ('gunxm' in $$props) $$invalidate(11, gunxm = $$props.gunxm);
		if ('acwrb' in $$props) $$invalidate(12, acwrb = $$props.acwrb);
		if ('meeuq' in $$props) $$invalidate(13, meeuq = $$props.meeuq);
...
function create_fragment$5(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				seo_title: "Press: Vogue UK | Foteini Chalkia",
				seo_description: "CHALKIA has been published at the 2021 May issue of the British Vogue, among the gallery of new designers."
			}
		});
	...
	component_1 = new Component$2({
			props: {
				...
				acwrb: {
					"image": {
						"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/vogue-cover.jpg",
						"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/vogue-cover.jpg",
						"alt": "NJAL",
						"size": null
					},
					"title": "Vogue UK",
					"subtitle": "Beauty's next superstars",
					"text": "<p>Our brand has been published at the 2021 May issue of the British Vogue, among the gallery of new designers. A great honour as Vogue is the ultimate magazine of fashion worldwide.</p>"
				},
				meeuq: {
					"badges": {
