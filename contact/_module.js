...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('jrorm' in $$props) $$invalidate(10, jrorm = $$props.jrorm);
		if ('eecrl' in $$props) $$invalidate(11, eecrl = $$props.eecrl);
		...
		if ('pmdst' in $$props) $$invalidate(14, pmdst = $$props.pmdst);
	};
...
function create_else_block$2(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text("We have received your message. One of our representatives will contact you as soon as possible.");
		},
		l(nodes) {
			div = claim_element(nodes, "DIV", {});
			var div_nodes = children(div);
			t = claim_text(div_nodes, "We have received your message. One of our representatives will contact you as soon as possible.");
...
function create_if_block$2(ctx) {
	...
	return {
		c() {
			...
			t7 = text("Choose a contact reason");
			option1 = element("option");
			t8 = text("I need a dress");
			option2 = element("option");
			t9 = text("I need a stylist");
			option3 = element("option");
			t10 = text("I want to display your work");
			t11 = space();
			textarea = element("textarea");
			t12 = space();
			label = element("label");
			input7 = element("input");
			t13 = text(" I accept the ");
			a_1 = element("a");
			t14 = text("Privacy Policy");
			t15 = space();
			input8 = element("input");
			this.h();
		},
		l(nodes) {
			form = claim_element(nodes, "FORM", { action: true, method: true, class: true });
			...
			input7 = claim_element(label_nodes, "INPUT", { type: true, id: true });
			t13 = claim_text(label_nodes, " I accept the ");
			a_1 = claim_element(label_nodes, "A", { href: true, target: true });
			var a_1_nodes = children(a_1);
			t14 = claim_text(a_1_nodes, "Privacy Policy");
			a_1_nodes.forEach(detach);
			label_nodes.forEach(detach);
			t15 = claim_space(form_nodes);
			input8 = claim_element(form_nodes, "INPUT", { type: true, class: true });
			form_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(input0, "type", "hidden");
			attr(input0, "name", "_to");
			input0.value = "photchalkia@gmail.com";
			attr(input0, "class", "svelte-5pjzwj");
			attr(input1, "type", "hidden");
			attr(input1, "name", "_formName");
			input1.value = "Επικοινωνία chalkia.com";
			attr(input1, "class", "svelte-5pjzwj");
			attr(input2, "type", "hidden");
			attr(input2, "name", "_redirectTo");
			input2.value = "https://chalkia.com/contact?sent";
			attr(input2, "class", "svelte-5pjzwj");
			attr(input3, "type", "text");
			attr(input3, "name", "Name");
			attr(input3, "placeholder", "Your name");
			input3.required = true;
			attr(input3, "class", "svelte-5pjzwj");
			attr(input4, "type", "text");
			attr(input4, "name", "Phone");
			attr(input4, "placeholder", "Your phone number");
			input4.required = true;
			attr(input4, "class", "svelte-5pjzwj");
			attr(input5, "type", "email");
			attr(input5, "name", "_replyTo");
			attr(input5, "placeholder", "Your email address");
			input5.required = true;
			attr(input5, "class", "svelte-5pjzwj");
			attr(input6, "id", "TEmail");
			attr(input6, "type", "email");
			attr(input6, "name", "_t_email");
			set_style(input6, "display", "none");
			attr(input6, "class", "svelte-5pjzwj");
			option0.__value = "";
			option0.value = option0.__value;
			option1.__value = "book";
			option1.value = option1.__value;
			option2.__value = "onsite";
			option2.value = option2.__value;
			option3.__value = "press";
			option3.value = option3.__value;
			attr(select, "name", "Subject");
			select.required = true;
			attr(select, "class", "svelte-5pjzwj");
			attr(textarea, "rows", "4");
			attr(textarea, "name", "Message");
			attr(textarea, "placeholder", "Type your message");
			textarea.required = true;
			attr(textarea, "class", "svelte-5pjzwj");
			attr(input7, "type", "checkbox");
			attr(input7, "id", "tos");
			input7.required = true;
			attr(a_1, "href", "/privacy-policy");
			attr(a_1, "target", "_new");
			attr(label, "for", "tos");
			attr(input8, "type", "submit");
			input8.value = "Send";
			attr(input8, "class", "button svelte-5pjzwj");
			attr(form, "action", "https://mailgate.dws.gr");
			attr(form, "method", "post");
			attr(form, "class", "svelte-5pjzwj");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*msgSent*/ ctx[2] === false) return create_if_block$2;
	...
	return {
		...
		h() {
			attr(h1, "class", "svelte-5pjzwj");
			attr(h3, "class", "svelte-5pjzwj");
			attr(div0, "class", "svelte-5pjzwj");
			attr(iframe, "title", "map");
			if (!src_url_equal(iframe.src, iframe_src_value = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12578.836831065471!2d23.74000815698169!3d37.98391508841099!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a1bddebc8f0df5%3A0x830182b03aa3d4bf!2sFoteini%20Chalkia!5e0!3m2!1sel!2sgr!4v1666850125772!5m2!1sel!2sgr")) attr(iframe, "src", iframe_src_value);
			...
			attr(iframe, "class", "svelte-5pjzwj");
			attr(div1, "class", "section-container svelte-5pjzwj");
			attr(main, "class", "svelte-5pjzwj");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let { title } = $$props;
	let { subtitle } = $$props;
	const msgSent = window.location.search.indexOf('sent') > -1;

	$$self.$$set = $$props => {
		if ('social' in $$props) $$invalidate(3, social = $$props.social);
		if ('na' in $$props) $$invalidate(4, na = $$props.na);
		if ('nav' in $$props) $$invalidate(5, nav = $$props.nav);
		if ('a' in $$props) $$invalidate(6, a = $$props.a);
		if ('add' in $$props) $$invalidate(7, add = $$props.add);
		if ('addre' in $$props) $$invalidate(8, addre = $$props.addre);
		if ('address' in $$props) $$invalidate(9, address = $$props.address);
		if ('phone' in $$props) $$invalidate(10, phone = $$props.phone);
		if ('email' in $$props) $$invalidate(11, email = $$props.email);
		if ('jrorm' in $$props) $$invalidate(12, jrorm = $$props.jrorm);
		if ('eecrl' in $$props) $$invalidate(13, eecrl = $$props.eecrl);
		...
		if ('pmdst' in $$props) $$invalidate(16, pmdst = $$props.pmdst);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('email' in $$props) $$invalidate(10, email = $$props.email);
		if ('jrorm' in $$props) $$invalidate(11, jrorm = $$props.jrorm);
		if ('eecrl' in $$props) $$invalidate(12, eecrl = $$props.eecrl);
		...
		if ('pmdst' in $$props) $$invalidate(15, pmdst = $$props.pmdst);
...
function create_fragment$5(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				seo_title: "Contact Us | Foteini Chalkia",
				seo_description: "Send us your deepest thoughts and desires. We will make sure you can wear them! Book an appointment at +30 210 220 4390"
			}
		});
