...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('seo' in $$props) $$invalidate(11, seo = $$props.seo);
...
function get_each_context_3(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[31] = list[i].image;
	child_ctx[33] = i;
	return child_ctx;
}

// (214:6) {#each gallery as {image}
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			if (!src_url_equal(img.src, img_src_value = /*image*/ ctx[31].src)) attr(img, "src", img_src_value);
			attr(img, "alt", img_alt_value = /*image*/ ctx[31].alt);
			attr(img, "class", "svelte-1s7ghsc");
			toggle_class(img, "active", /*activeSlide*/ ctx[3] === /*i*/ ctx[33]);
		},
		m(target, anchor) {
			insert_hydration(target, img, anchor);
		},
		p(ctx, dirty) {
			if (dirty[0] & /*gallery*/ 4 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[31].src)) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*gallery*/ 4 && img_alt_value !== (img_alt_value = /*image*/ ctx[31].alt)) {
				attr(img, "alt", img_alt_value);
			}

			if (dirty[0] & /*activeSlide*/ 8) {
				toggle_class(img, "active", /*activeSlide*/ ctx[3] === /*i*/ ctx[33]);
			}
		},
		d(detaching) {
...
function create_else_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(nav_1, "class", "svelte-1s7ghsc");
		},
		m(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*mobileMenu*/ ctx[8] === true) return 0;
		if (/*mobileMenu*/ ctx[8] === false) return 1;
		return 2;
	}
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1s7ghsc");
			toggle_class(button, "active", /*mobileMenu*/ ctx[8] === true);
			attr(div0, "id", "mobileMenuContent");
			attr(div0, "class", "svelte-1s7ghsc");
			toggle_class(div0, "active", /*mobileMenu*/ ctx[8] === true);
			attr(div1, "id", "mobileMenu");
			attr(div1, "class", "svelte-1s7ghsc");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty[0] & /*mobileMenu*/ 256) {
				toggle_class(button, "active", /*mobileMenu*/ ctx[8] === true);
			}
...
// (238:4) {#each nav as {link}}
function create_each_block_2(ctx) {
	let a_1;
	let t_value = /*link*/ ctx[22].label + "";
	let t;
	let a_1_href_value;
	...
	return {
		...
		l(nodes) {
			...
			t = claim_text(a_1_nodes, t_value);
			a_1_nodes.forEach(detach);
			this.h();
		},
		h() {
			attr(a_1, "href", a_1_href_value = /*link*/ ctx[22].url);
			attr(a_1, "class", "svelte-1s7ghsc");
			toggle_class(a_1, "active", /*link*/ ctx[22].active === true);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*nav*/ 2 && t_value !== (t_value = /*link*/ ctx[22].label + "")) set_data(t, t_value);

			if (dirty[0] & /*nav*/ 2 && a_1_href_value !== (a_1_href_value = /*link*/ ctx[22].url)) {
...
function create_each_block_1(ctx) {
	...
	return {
		...
		l(nodes) {
			a_1 = claim_element(nodes, "A", { href: true, class: true });
			var a_1_nodes = children(a_1);
			h3 = claim_element(a_1_nodes, "H3", { class: true });
...
// (248:6) {#each social as {link, title, icon}}
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(a_1, "href", a_1_href_value = /*link*/ ctx[22]);
			attr(a_1, "title", a_1_title_value = /*title*/ ctx[23]);
			attr(a_1, "class", "svelte-1s7ghsc");
		},
		m(target, anchor) {
			insert_hydration(target, a_1, anchor);
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty[0] & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[24];
			icon.$set(icon_changes);

			if (!current || dirty[0] & /*social*/ 1 && a_1_href_value !== (a_1_href_value = /*link*/ ctx[22])) {
				attr(a_1, "href", a_1_href_value);
			}

			if (!current || dirty[0] & /*social*/ 1 && a_1_title_value !== (a_1_title_value = /*title*/ ctx[23])) {
...
function create_fragment$2(ctx) {
	...
	let t3;
	let h3;
	let t4_value = /*gallery*/ ctx[2][/*activeSlide*/ ctx[3]].image.alt + "";
	let t4;
	let t5;
	let div2;
	let t6;
	...
	let t9;
	let current;
	let each_value_3 = /*gallery*/ ctx[2];
	let each_blocks_1 = [];
	...
	return {
		c() {
			...
			t7 = text("© 2022");
			t8 = text(/*cp*/ ctx[7]);
			t9 = text(" Foteini Chalkia - All rights reserved");
			this.h();
		},
		l(nodes) {
			...
			div3 = claim_element(div4_nodes, "DIV", { id: true, style: true });
			var div3_nodes = children(div3);
			header = claim_element(div3_nodes, "HEADER", { class: true });
			var header_nodes = children(header);

			for (let i = 0; i < each_blocks_1.length; i += 1) {
				each_blocks_1[i].l(header_nodes);
			}
			...
			t2 = claim_text(h1_nodes, "CHALKIA");
			...
			var div1_nodes = children(div1);
			t7 = claim_text(div1_nodes, "© 2022");
			t8 = claim_text(div1_nodes, /*cp*/ ctx[7]);
			t9 = claim_text(div1_nodes, " Foteini Chalkia - All rights reserved");
			div1_nodes.forEach(detach);
		...
		h() {
			attr(header, "class", "svelte-1s7ghsc");
			attr(h1, "class", "svelte-1s7ghsc");
			attr(h3, "class", "svelte-1s7ghsc");
			attr(div1, "class", "copyright svelte-1s7ghsc");
			attr(div2, "class", "social svelte-1s7ghsc");
			attr(main, "class", "svelte-1s7ghsc");
			attr(div3, "id", "root");
			set_style(div3, "--fullHeight", /*vh*/ ctx[6] + "px");
		...
		p(ctx, dirty) {
			if (dirty[0] & /*gallery, activeSlide*/ 12) {
				each_value_3 = /*gallery*/ ctx[2];
				let i;
			...
			if ((!current || dirty[0] & /*gallery, activeSlide*/ 12) && t4_value !== (t4_value = /*gallery*/ ctx[2][/*activeSlide*/ ctx[3]].image.alt + "")) set_data(t4, t4_value);
			...
			if (!current || dirty[0] & /*cp*/ 128) set_data(t8, /*cp*/ ctx[7]);

			if (!current || dirty[0] & /*vh*/ 64) {
				set_style(div3, "--fullHeight", /*vh*/ ctx[6] + "px");
			}
		},
		i(local) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		$$invalidate(5, vw = window.innerWidth);
		$$invalidate(6, vh = window.innerHeight);

		setInterval(
			() => {
				wrapper.children[activeSlide].classList.remove('active');

				$$invalidate(3, activeSlide = wrapper.children.length > activeSlide + 1
				? activeSlide + 1
				: 0);
	...
	const click_handler = () => $$invalidate(8, mobileMenu = !mobileMenu);

	$$self.$$set = $$props => {
		if ('social' in $$props) $$invalidate(0, social = $$props.social);
		if ('na' in $$props) $$invalidate(9, na = $$props.na);
		...
		if ('seo' in $$props) $$invalidate(16, seo = $$props.seo);
		...
		if ('sfncm' in $$props) $$invalidate(19, sfncm = $$props.sfncm);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('seo' in $$props) $$invalidate(9, seo = $$props.seo);
		if ('seo_title' in $$props) $$invalidate(10, seo_title = $$props.seo_title);
		if ('seo_description' in $$props) $$invalidate(11, seo_description = $$props.seo_description);
	};
...
function create_fragment$3(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				seo: "Enim in aliqua",
				seo_title: "Bridal Dresses & Haute Couture | Foteini Chalkia",
				seo_description: "We will create a unique bridal or evening gown for your taste. Book your appointment now at +30 210 220 4390."
			}
		});
			...
			props: {
				...
				sfncm: {
					"gallery": [
						{
							"image": {
								"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/3.jpg",
								"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/3.jpg",
								"alt": "Bridal | This is your special day, own it",
								"size": 99
							}
						},
						{
							"image": {
								"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/1.jpg",
								"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/1.jpg",
								"alt": "Haute Couture | Dazzle everyone with your unique style",
								"size": 69
							}
						},
						{
							"image": {
								"url": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/2.jpg",
								"src": "https://zzyumdkmbkvyfpswmpyz.supabase.co/storage/v1/object/public/sites/chalkia/assets/2.jpg",
								"alt": "Conceptual | Clothes are more than wearables, they are art",
								"size": 169
							}
						}
					]
